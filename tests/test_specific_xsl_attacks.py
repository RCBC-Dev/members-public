...
class SpecificXSLAttackTest(TestCase):
    ...
    def setUp(self):
        ...
        self.decoded_patterns = [
            urllib.parse.unquote(pattern) for pattern in self.attack_patterns
        ]
    ...
    def test_specific_xsl_attacks_blocked(self):
        ...
        for i, attack in enumerate(self.attack_patterns):
            ...
            self.assertEqual(
                ...
                400,
                f"Attack {i+1} was not blocked: {self.decoded_patterns[i]}",
            )
    ...
    def test_legitimate_microsoft_login_allowed(self):
        ...
        self.assertNotEqual(
            response.status_code, 400, "Legitimate request was incorrectly blocked"
        )

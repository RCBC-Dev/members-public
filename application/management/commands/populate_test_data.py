...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        contacts_data = [
            ('Planning Enquiries', sections[1], [job_types[1]]),  # Planning Applications section
            ('Highways Maintenance', sections[2], [job_types[0], job_types[3]]),  # Road Maintenance section
            ('Environmental Services', sections[3], [job_types[4], job_types[5]]),  # Street Cleaning section
            ('Housing Support', sections[4], [job_types[2]]),  # Housing Benefits section
            ('Waste Collection', sections[3], [job_types[7]]),  # Street Cleaning section

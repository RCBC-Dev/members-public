...
class MessageService:
    ...
    @classmethod
    def add_message(
        cls, request, message_type: str, message: str, extra_tags: str = ""
    ) -> None:
        """
    ...
    def create_error_response(
        cls, error: str, data: Optional[Dict] = None
    ) -> JsonResponse:
...
def create_json_response(
    success: bool, message: str = "", error: str = "", data: Optional[Dict] = None
) -> JsonResponse:
